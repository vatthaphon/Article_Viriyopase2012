...
tend=100;
global r_Period s_SecondHalf figOption

phi1_min=0.2;phi1_max=phi1_min;phi1len=1;
phi2_min=0.1;phi2_max=phi2_min;phi2len=1;

tau1_min=0.1;tau1_max=tau1_min;tau1len=1;
tau3_min=0.1;tau3_max=tau3_min;tau3len=1;

epsi12_min=0.05;epsi12_max=epsi12_min;epsi12len=1;
epsi21_min=0.05;epsi21_max=epsi21_min;epsi21len=1;
epsi32_min=0.05;epsi32_max=epsi32_min;epsi32len=1;
epsi23_min=0.05;epsi23_max=epsi23_min;epsi23len=1;

theta_c(epsi12_min, 3)
            ...
            for k=1:1:tau1len
                ...
                if isSymE
                    for m=1:1:epsi12len
                        ...
                        epsi32=epsi12;
                        epsi23=epsi12;
retStr=TimeBased_3MS_osc_PRC(init_phi1, init_phi2, tau1, tau3, epsi12, epsi21, epsi32, epsi23, tend, PRC_option);                        
