...
% [11 Apr. 2011]    This version is different from "TimeBased_3MS_osc_with_Hebb_BiPoo" in the following:
%                   - The process freshly starts at 0. Therefore, we don't take in to account spike inputs generated by spiking of the oscillators before 0.  
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [rec_SpTi1 rec_SpTi2 rec_SpTi3 rec_12_arr rec_21_arr rec_23_arr rec_32_arr o_w_12 o_w_21 o_w_23 o_w_32]...
            =TimeBased_3MS_osc_with_Hebb_BiPoo_Process_Start_at_0(p_phi1, p_phi3, p_tau1, p_tau3, p_epsi12, p_epsi21, p_epsi32, p_epsi23, p_tEnd, p_option, p_dt)
global max_cs        
%%%%%% Parameters %%%%%%
option=p_option;
b=3;            
...
init_phi1=p_phi1;init_phi3=p_phi3;
%%%%%% Initialize variables %%%%%%
phi=[init_phi1; 0; init_phi3];
...
%     if (t>0.3997)
%         isInInt(t, t+dt, SpTi3(1,a_time3)+tau3)
%     end
